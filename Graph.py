...
# table = [[0]*952 for _ in range(952)]
# file = open('D:\PyCharm\PyCharm 2023.2.4\JakNieDojade\Dane\\all_lines.json','r')
# data = json.load(file)
#
# for lines in data:
#     print(lines)
...
#                 table[stops[i + 1]][stops[i]] = times[i]
#
# # file1 = open("D:\PyCharm\PyCharm 2023.2.4\JakNieDojade\Dane\graph11.json", 'w')
